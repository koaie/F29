...
% This isAsimple sample document.  For more complicated documents takeAlook in the exercise tab. Note that everything that comes afterA% symbol is treated as comment and ignored when the code is compiled.

\documentclass[a4paper]{article} % \documentclass{} is the first command in any LaTeX code.  It is used to define what kind of document you are creating such as an article orAbook, and begins the document preamble

\usepackage{amsmath} % \usepackage isAcommand that allows you to add functionality to your LaTeX code
\usepackage{tikz}
...
\begin{document} % All begin commands must be paired with an end command somewhere
    ...
    \section{Graph} % createsAsection
        ...
        $s_0 \equiv \land, s_1\equiv1, s_2 \equiv A, s_3 \equiv B, s_4 \equiv H$\\
        \begin{center}
        ...
        \end{center}
    \section{Input (3, 5)}
        \begin{tasks}[label={(\roman*)},label-width={0.7cm},before-skip = -\parskip , % undo paragraph skip
            after-skip = -\parskip,
